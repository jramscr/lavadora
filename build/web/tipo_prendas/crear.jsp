                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        ...
                                        <h4>Crear Tipo de Prenda</h4>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <form class="form form-vertical" action="${pageContext.request.contextPath}/tipo_prendas" method="post">
                                        ...
                                        <div class="control-group">
                                            <label></label>
                                            <div class="controls">
                                                <input type="submit" name="signup" value="Crear Tipo de Prenda" class="btn btn-success">
                                            </div>
                                        </div>
                                    </form>
                                </div>
