...
<%@page import="logica.modelos.TipoTela"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Información del Tipo de Tela</title>
    </head>
    <body>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        ...
                                        <h4>Detalles del Tipo de Tela</h4>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <% if (request.getAttribute("tipo_tela") != null) {
                                        TipoTela tipo_tela = (TipoTela) request.getAttribute("tipo_tela");
                                    %>
                                        <h1>Información del Tipo de Tela</h1>
                                        <div>Nombre: <%= tipo_tela.getNombre() %></div>
                                    <% } else { %>
                                        <h1>No se encontró el tipo de tela</h1>
                                    <% } %>
                                </div>
                                <!--/panel content-->
                            </div>
