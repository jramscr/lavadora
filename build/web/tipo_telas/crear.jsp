                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        ...
                                        <h4>Crear Tipo de Tela</h4>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <form class="form form-vertical" action="${pageContext.request.contextPath}/tipo_telas" method="post">
                                        ...
                                        <div class="control-group">
                                            <label></label>
                                            <div class="controls">
                                                <input type="submit" name="signup" value="Crear Tipo de Tela" class="btn btn-success">
                                            </div>
                                        </div>
                                    </form>
                                </div>
