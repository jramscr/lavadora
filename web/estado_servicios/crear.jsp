                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        ...
                                        <h4>Crear Estado de Servicio</h4>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <form class="form form-vertical" action="${pageContext.request.contextPath}/estado_servicios" method="post">
                                        ...
                                        <div class="control-group">
                                            <label></label>
                                            <div class="controls">
                                                <input type="submit" name="signup" value="Crear Estado de Servicio" class="btn btn-success">
                                            </div>
                                        </div>
                                    </form>
                                </div>
