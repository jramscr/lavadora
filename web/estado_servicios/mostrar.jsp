...
<%@page import="logica.modelos.EstadoServicio"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Información del Estado de Servicio</title>
    </head>
    <body>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        ...
                                        <h4>Detalles del Tipo de Prenda</h4>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <% if (request.getAttribute("estado_servicio") != null) {
                                        EstadoServicio estado_servicio = (EstadoServicio) request.getAttribute("estado_servicio");
                                    %>
                                        <h1>Información del Tipo de Prenda</h1>
                                        <div>Nombre: <%= estado_servicio.getNombre() %></div>
                                    <% } else { %>
                                        <h1>No se encontró el estado de servicio</h1>
                                    <% } %>
                                </div>
                                <!--/panel content-->
                            </div>
