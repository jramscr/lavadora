...
<html>
    <head>
        ...
        <title>Lista de Tipo de Telas</title>
    </head>
    <body>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="table-responsive">
                                    <%
                                        ...
                                        ArrayList<Object> tipo_telas = manager.obtenerLista("TipoTela");
                                    %>
                                    <% if (tipo_telas != null) { %>
                                        <table class="table table-striped">
                                            ...
                                            <% for(Object tipo_tela : tipo_telas) { %>
                                                <% List<String> valores = manager.obtenerValoresDeAtributos(tipo_tela); %>
                                                <tr>
                                                    <td><%= valores.get(1) %></td>
                                                    <td></td>
                                                </tr>
                                    ...
                                    <% } else { %>
                                        <h1>No se han registrado tipos de tela todavía.</h1>
                                    <% }%>
                                </div>
                                <!--/panel content-->
                            </div>
