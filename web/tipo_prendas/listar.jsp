...
<html>
    <head>
        ...
        <title>Lista de Tipo de Prendas</title>
    </head>
    <body>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="table-responsive">
                                    <%
                                        ...
                                        ArrayList<Object> tipo_prendas = manager.obtenerLista("TipoPrenda");
                                    %>
                                    <% if (tipo_prendas != null) { %>
                                        <table class="table table-striped">
                                            ...
                                            <% for(Object tipo_prenda : tipo_prendas) { %>
                                                <% List<String> valores = manager.obtenerValoresDeAtributos(tipo_prenda); %>
                                                <tr>
                                                    <td><%= valores.get(1) %></td>
                                                    <td></td>
                                                </tr>
                                    ...
                                    <% } else { %>
                                        <h1>No se han registrado tipos de prenda todavía.</h1>
                                    <% }%>
                                </div>
                                <!--/panel content-->
                            </div>
