...
<%@page import="logica.modelos.TipoPrenda"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Información del Tipo de Prenda</title>
    </head>
    <body>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <% if (request.getAttribute("tipo_prenda") != null) {
                                        TipoPrenda tipo_prenda = (TipoPrenda) request.getAttribute("tipo_prenda");
                                    %>
                                        <h1>Información del Tipo de Prenda</h1>
                                        <div>Nombre: <%= tipo_prenda.getNombre() %></div>
                                    <% } else { %>
                                        <h1>No se encontró el tipo de prenda</h1>
                                    <% } %>
                                </div>
                                <!--/panel content-->
                            </div>
